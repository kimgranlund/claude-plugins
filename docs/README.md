...
v1.10.1 · 2026-08-16 · product-authoring cold-start branch, binding addendum landed after v1.10.0 merged (#404): adoption onto a project with no intent layer is a first-class branch, not an error; new `product-lifecycle-rules/references/cold-start-adoption.md`, agent body stays a pointer under the body cap.
