...
matters, dispatch **doc-checker** (fresh context, this rubric) rather than grading your own argument.
...
| `references/rubric.md` | Score the memo (gate = V1 thesis, V6 voice); the standard **doc-checker** loads |
...
- **[[find-intent]]** / **[[grill-the-ask]]** sharpen a fuzzy "make the case for X" into a statable
...
- **[[make-rubric]]** owns `references/rubric.md`'s shape.
