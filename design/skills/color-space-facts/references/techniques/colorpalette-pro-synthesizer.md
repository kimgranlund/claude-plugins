...
**Related:** [pro-color-harmonies](../../../color-theory-facts/references/techniques/pro-color-harmonies.md) is a standalone JS library by @meodai that reimplements the same harmony logic as a dependency-free lib, built with consent from Color Palette Pro's author. Same 4 styles (square/triangle/circle/diamond), but usable programmatically without the web UI.
