...
kit, dispatch the independent design-system-checker seat (or doc-checker bound to
...
| [[make-design-system]] (hub) | Cross-platform strategy; sibling exports for other platforms route to make-dscard-kit / make-stitch-kit |
