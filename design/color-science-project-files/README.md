...
- **`physical-color-facts`** (30 files) — physical color & naming: pigment
...
`../color-contrast-facts/`, `../physical-color-facts/`.
...
`color-contrast-facts`, `physical-color-facts`. Each is self-contained
