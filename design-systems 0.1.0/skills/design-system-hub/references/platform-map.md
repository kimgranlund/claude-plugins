...
(`design-system-author-dscard` / `-google-stitch` / `-figma-make`); re-derive this
...
| **Owning sibling** | design-system-author-google-stitch | design-system-author-dscard | design-system-author-figma-make |
...
`design-system-author-figma-make/references/shadcn-tailwind-flavor.md`. This is the
