...
| D2 | Contrast | [gate] | every declared fill/foreground pair ≥ 4.5:1 in both schemes; `-on-surface*` × surface all-pairs included | 1: any pair below 4.5:1 · 3: all pairs pass · 5: all pairs pass with headroom on body-text pairs, translucent tokens annotated with their backdrop proof |
