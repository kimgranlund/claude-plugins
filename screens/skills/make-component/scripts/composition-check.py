#!/usr/bin/env python3
"""composition-check.py — the COMPOSITION card gate (make-component's COMPOSE A4 / A5).
...
boundary hands UP to break-down-layout (this gate stops at the module; the page / region grid it sits
in is break-down-layout's).
