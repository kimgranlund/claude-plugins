...
# check-safety — destructive-action invariants, card-gated
...
| [[check-focus]] | enforces Cancel-as-default-focus and Escape handling |
| [[make-component]] | fix owner for affordance findings — the confirm dialog, undo toast, or type-to-confirm input a verdict prescribes is built there |
