...
- **Growth by tolerance**: motion, icon-rules, elevation physics, casing — extra sections + free-form token groups, no spec change needed, because tokens are context rather than instruction.
