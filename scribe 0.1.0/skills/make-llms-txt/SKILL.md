...
description: >
  ...
  the docs themselves (make-reference).
...
- The corpus it indexes is authored with `[[make-reference]]` (knowledge / ground-truth docs) and a repo's docs-site skill (agent-ui carries `docs-author` repo-locally — the published site); this maps what they produce.
...
| `references/best-practices.md` | Covers references and llms.txt — canon home: make-reference; this bundle symlinks in |
