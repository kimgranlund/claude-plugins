...
description: >-
  ...
  peers. NOT for a single reference document (reference-author); NOT for a procedure skill
...
# knowledge-author — mint world models
...
| Peer | For |
|---|---|
| [[reference-author]] | the per-file standard each reference is written to |
| [[skill-author]] | the entry surface's gates + the create/evaluate/improve loop |
| [[rubric-author]] | when the pack needs a scoring standard alongside the corpus |
