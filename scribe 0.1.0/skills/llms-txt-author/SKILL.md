...
description: >
  ...
  the docs themselves (reference-author).
...
- The corpus it indexes is authored with `[[reference-author]]` (knowledge / ground-truth docs) and a repo's docs-site skill (agent-ui carries `docs-author` repo-locally — the published site); this maps what they produce.
...
| `references/best-practices.md` | Covers references and llms.txt — canon home: reference-author; this bundle symlinks in |
