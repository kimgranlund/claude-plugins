...
TICKET path, repo-rooted per doc-authoring-standards), Option B (git-native — `gh issue`, an
...
different store. Canonical statement: `bug-report`'s SKILL.md — this is the same seam, not a
