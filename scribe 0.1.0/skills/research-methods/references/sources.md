...
**Adding or re-homing a method** is authoring work — route to harness's `make-pack` (axis
decomposition, a grounded research wave, index discipline). A new method lands with its citation
added here, never as an uncited protocol bolted on inline.
