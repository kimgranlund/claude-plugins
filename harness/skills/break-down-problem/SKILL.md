...
description: >-
  ...
  task. NOT for authoring PRD/SPEC/LLD; NOT authoring skills (make-skill); NOT a split/merge
  decision (plan-skill-split); NOT a concrete UI layout — screens, regions, wireframes (frontend's
  break-down-layout).
