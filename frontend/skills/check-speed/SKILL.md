...
# check-speed — perceived-latency invariants, card-gated
...
| [[make-component]] | the maker seat — recipe/reservation/streaming defects route there (or the repo's component seat) for the fix |
| [[check-safety]] | shares the recall/cancellation contract for long destructive operations |
