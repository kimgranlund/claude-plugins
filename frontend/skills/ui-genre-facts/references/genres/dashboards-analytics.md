---
date: 2026-06-03
curated: 2026-07-02 — harvested from the product-forge product-genres corpus; product-metrics section dropped, UI conventions kept
...
A review should first ask which kind of dashboard it is judging, because the two have different success criteria.
...
Where the tracking genre's distinctive hazard is the streak trap, the dashboard genre's is alert fatigue — and a review should score it explicitly.
