...
description: >-
  ...
  disclosed. Run /bind-review [optional repo root] to open it, ending only when you say so. NOT a
  one-off review (dispatch the owning checker directly); NOT a coordination charter (/bind-team);
  NOT the standing intake or build seats (/bind-intake, /bind-build); NOT an unattended dispatch
