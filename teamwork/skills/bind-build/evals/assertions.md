# bind-build — behavioral assertions (Phase 2)

Checked with/without in Phase 5. "The session" = a session that ran /bind-build.

1. **Adoption acknowledgment:** immediately after /bind-build, the session's reply names the
