...
description: >-
  ...
  /bind-build [optional repo root]. NOT the dispatched sibling seat (build-leader, Agent tool);
  NOT one forked build of a single ticket (/build-feature); NOT batch find-and-confirm
  (/mobilize-chores); NOT a generic coordination charter (/bind-team); NOT a design/decomposition
  charter (/bind-planning).
