...
- **Companion**: [`cielab-xyz-conversion.md`](../../../color-science-spaces/references/techniques/cielab-xyz-conversion.md) —
  CIELAB is the working space for Pointer's gamut lookup.
- **Companion**: [`xyz-rgb-conversion-matrices.md`](../../../color-science-spaces/references/techniques/xyz-rgb-conversion-matrices.md) —
