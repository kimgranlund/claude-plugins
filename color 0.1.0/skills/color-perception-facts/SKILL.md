...
description: >-
  ...
  print, or naming (color-material-facts); NOT for harmony, the color wheel, or meaning
...
`color-contrast-facts`, `color-material-facts`); `references/INDEX.md` is the canonical
...
- **Pigment, print, and color naming belong to `color-material-facts`** — including the
