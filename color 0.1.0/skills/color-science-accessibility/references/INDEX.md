...
Curated transcripts, notes, and source material for the `color-science-accessibility` pack —
...
sibling packs (`color-science-spaces`, `color-science-perception`, `color-science-materials`) took
...
## Cited from color-science-spaces (the one intentional cross-pack consult)
...
| File (in color-science-spaces) | Why this pack cites it |
| --- | --- |
| *CSS Color 2026 — Spec & Baseline Snapshot* (in `color-science-spaces`) | Dated Baseline/spec-status map, incl. WCAG 3 Working Draft status — never duplicated here, always cited |
