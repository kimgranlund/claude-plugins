...
`color-science-accessibility` — the boundary-routing prompt (task 5 of the original 8). See
...
Good answer (since the 2026-07-02 split, the harmony corpus lives in the `color-theory` pack; this
...
- routes the *harmony/aesthetics* half to `color-theory` rather than improvising wheel talk
