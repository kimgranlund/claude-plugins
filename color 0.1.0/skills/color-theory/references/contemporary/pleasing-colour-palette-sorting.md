...
**Source:** original local research report (unpublished; PDF not shipped — this file is the canonical record)
**Dataset:** 601 curated Lospec palettes
**Color space:** OKLab
**Date:** 2025-12-22
**Attribution note:** no named author surfaced in the extracted text or PDF metadata
**PDF:** not shipped with this pack; this transcription is the canonical record
