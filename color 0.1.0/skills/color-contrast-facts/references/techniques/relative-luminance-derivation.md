...
- **Perceived lightness ($L^*$ or $J$)**: a perceptual quantity. How bright the
  ...
  [`cielab-xyz-conversion.md`](../../../color-space-facts/references/techniques/cielab-xyz-conversion.md)).
...
[`gamma-transfer-functions.md`](../../../color-space-facts/references/techniques/gamma-transfer-functions.md)), then apply
the linear formula:
