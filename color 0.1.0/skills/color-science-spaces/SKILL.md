...
description: >-
  ...
  color-science-project-files). NOT for contrast, CVD, or legibility (color-science-accessibility);
  NOT for vision mechanics (color-science-perception); NOT for pigment, print, or color naming
  (color-science-materials); NOT for harmony or meaning (color-theory); NOT for a color ramp or
  semantic tokens (palette-design; token-builder). ANSWERS, does not generate.
disable-model-invocation: false
user-invocable: false
---

# color-science-spaces — the spaces and the math
...
siblings answer adjacent questions about the *same* colors: [[color-science-perception]] answers why
vision works that way, [[color-science-accessibility]] answers contrast standards and CVD,
[[color-science-materials]] answers pigment/print/naming. Extracted 2026-07-06 from the monolithic
...
[[color-theory]]'s; this pack only demos the computation.
...
- Pigment mixing, print/ICC, color naming standards → [[color-science-materials]].
- Harmony, the color wheel, meaning/mood → [[color-theory]].
- Building a ramp, theme, or semantic token mapping → `palette-design` (design work) or the
...
- Verifying a candidate palette end-to-end (ColorProof, pass/fail) → [[color-verify]].
