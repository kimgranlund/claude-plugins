...
- **APCA-checked contrast** → Use OKLCH for derivation + APCA for verification ([`apca-myndex-contrast.md`](../../../color-science-accessibility/references/techniques/apca-myndex-contrast.md), color-science-accessibility) — HCT's WCAG-tuned tone deltas don't translate directly to APCA Lc thresholds.
