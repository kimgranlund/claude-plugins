...
For richer contrast logic — including APCA-aware color selection — use [`apcach`](https://github.com/antiflasher/apcach) and see [`apca-myndex-contrast.md`](../../../color-science-accessibility/references/techniques/apca-myndex-contrast.md) (color-science-accessibility).
