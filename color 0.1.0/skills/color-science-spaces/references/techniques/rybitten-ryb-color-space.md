...
- Relates to [RYB vs CMY Color Wheels](../../../color-theory/references/historical/ryb-vs-cmy-color-wheels.md) (color-theory pack) — this library lets you work WITH the RYB model despite its scientific limitations
- The historical cubes connect to [Ostwald](../../../color-theory/references/historical/ostwald-color-wheel.md), [Bezold](../../../color-theory/references/historical/what-happened-to-indigo.md), [Amy Sawyer](../../../color-theory/references/historical/amy-sawyer-forgotten-color-theorist.md) (color-theory pack)
- Itten's system critiqued in [CSA — Itten's Seven Contrasts](../../../color-theory/references/historical/itten-seven-contrasts-critical-review.md) (color-theory pack)
