...
- [`ciecam02-color-appearance-model.md`](../../../color-perception-facts/references/contemporary/ciecam02-color-appearance-model.md) — predecessor model (still cited in older tooling; lives in color-perception-facts).
- [`fairchild-color-appearance-models.md`](../../../color-perception-facts/references/contemporary/fairchild-color-appearance-models.md) — broader appearance-models reference (color-perception-facts).
