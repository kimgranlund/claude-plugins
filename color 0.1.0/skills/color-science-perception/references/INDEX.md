...
Curated transcripts, notes, and source material for the `color-science-perception` pack — vision
...
**Extracted 2026-07-06** from the `color-science` pack (split into four: `color-science-spaces`,
`color-science-perception`, `color-science-accessibility`, `color-science-materials`). Aesthetics,
meaning, and history live in the sibling `color-theory` pack (split 2026-07-02, predates this
extraction); color-theory cites four of this pack's files for the perceptual mechanism under an
...
| 5. Subtractive Mixing | [ch05](contemporary/huevaluechroma/ch05-subtractive-mixing.md) (cross-cited from `color-science-materials` — paint mixing) |
| 6. Mixing of Paints | [ch06](contemporary/huevaluechroma/ch06-mixing-of-paints.md) (cross-cited from `color-science-materials` — paint mixing) |
...
| [Color Spaces](contemporary/colorandcontrast/color-spaces.md) | sRGB, P3, LMS, XYZ, CIELAB, OKLAB, CAM16 (cross-cited from `color-science-spaces`) |
...
| [Accessibility](contemporary/colorandcontrast/accessibility.md) | APCA, CVD, confusion lines, luminance (cross-cited from `color-science-accessibility`) |
...
## Straddle files (cited from color-theory — the perceptual mechanism under an aesthetic effect)

`color-theory`'s corpus documents harmony, meaning, and history; five files across the family carry
...
`color-science-accessibility` (its load-bearing claim is CVD-safe pairs; this pack's scrapes cover
opponent process as vision science) and `goethe-edge-colors-design-hack` in
`color-science-spaces` (it is gradient math, not appearance science).
...
Bruce MacEvoy's pigment-data site (handprint.com) is catalogued in `color-science-materials`'s
...
`color-science-materials`' INDEX — this pack owns only the Helmholtz row (foundational modern color
