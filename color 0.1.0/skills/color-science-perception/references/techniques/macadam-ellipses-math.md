...
- **Companion** (in `color-science-spaces`): [`oklab-xyz-math.md`](../../../color-science-spaces/references/techniques/oklab-xyz-math.md) —
  OKLab's uniformity is calibrated against MacAdam-style data.
- **Companion** (in `color-science-spaces`): [`delta-e-formulas.md`](../../../color-science-spaces/references/techniques/delta-e-formulas.md) —
