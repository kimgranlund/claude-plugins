#!/usr/bin/env python3
"""contrast-check.py — the color-verify mechanism gate. Self-contained (stdlib only).

color-verify owns the *how* of color proof: it takes candidate pairs and proves they behave.
