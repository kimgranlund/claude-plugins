...
Curated transcripts, notes, and source material for the `color-material-facts` pack — pigment
...
`color-material-facts`); prior history lives in `color-science-project-files`'s changelog.
