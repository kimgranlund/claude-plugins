...
`color-perception-facts`, `color-contrast-facts`, `color-material-facts`). Aesthetics,
...
| 5. Subtractive Mixing | [ch05](contemporary/huevaluechroma/ch05-subtractive-mixing.md) (cross-cited from `color-material-facts` — paint mixing) |
| 6. Mixing of Paints | [ch06](contemporary/huevaluechroma/ch06-mixing-of-paints.md) (cross-cited from `color-material-facts` — paint mixing) |
...
Bruce MacEvoy's pigment-data site (handprint.com) is catalogued in `color-material-facts`'s
...
`color-material-facts`' INDEX — this pack owns only the Helmholtz row (foundational modern color
