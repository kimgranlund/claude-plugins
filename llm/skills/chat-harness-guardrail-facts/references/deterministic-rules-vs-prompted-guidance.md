...
instance:** `harness/skills/hook-writing-rules/SKILL.md:17-19`. That same file states
...
the model to self-count characters.** **Worked instance:** `harness/hooks/hooks.json:3-13`
...
**Claim, from `hook-writing-rules` (`harness/skills/hook-writing-rules/SKILL.md:32`):**
