...
- `/Users/kimba/Projects/nonoun/plugins/README.md:33-45` — the real marketplace install sequence
  ...
  steps.
- `harness/skills/hook-writing-rules/SKILL.md:15,17-19,31,32` — the routing test
...
- `harness/hooks/hooks.json:3-13` and `harness/scripts/skill_lint.py:180-183` — the real
