...
| Ask class | Axis | File |
|---|---|---|
| "what does one catalog row declare?" · properties, value mark, child model, `checks` · "should this prop get a value mark?" (the readback law) · enum widening · "validated clean but renders wrong" | Component definition contract | `component-definition-contract.md` |
...
| "what is our coverage policy?" · "why is this control uncatalogued?" · CI-silent vs fleet-derived gate, allowlist, seed-and-drain · "mint a component or teach a composition?" · v1 scope floors · NESTED_ONLY vs browsable | Coverage policy & drift gates | `coverage-policy-and-drift-gates.md` |
