---
date: 2026-06-03
curated: 2026-07-02 — harvested from the product-forge product-genres corpus; the metrics section and benchmark pitfalls dropped, UI conventions kept (the regulatory split stays — it governs on-screen claims, consent, and disclaimer copy)
coverage: expanded
primary_sources:
...
- **Designs for adherence, not just acquisition.** Reminders, streaks, check-ins, and re-engagement are first-class — because the literature is unambiguous that the median trajectory is decline (Eysenbach's law of attrition).
