...
# layout-decompose — read a UI on two crossing axes
...
> 3. **Name it:** match the shell to an archetype (`../ui-patterns/references/archetype-*.md`) and pull its wireframe + vocabulary.
...
Four shells cover most software UIs. The wireframes live in [[ui-patterns]] (the world model); each carries a primary wireframe, the **named-pattern vocabulary**,
...
|---|---|---|---|
| **productivity-shell** | a tool you *work in* — editor, designer, cockpit, IDE; one artifact, framed by analysis + properties | app-header · app-pane-left · app-canvas(-header/-footer) · app-pane-right · app-footer · command-bar | `../ui-patterns/references/archetype-productivity-shell.md` |
| **saas-dashboard** | an app you *navigate* — many pages, records, settings; a clamshell around page content | sidebar-nav (collapsible · accordion · flyout · user) · section-nav · breadcrumbs · page-header (title/desc/actions/tabs) · table / data / settings content · modal/drawer/snackbar | `../ui-patterns/references/archetype-saas-dashboard.md` |
| **marketing-site** | a site you *read* to convert — homepage, feature, about, pricing, lead-gen, blog | global-nav · hero · features-grid · pricing · social-proof · footer-sitemap; per-page section stacks | `../ui-patterns/references/archetype-marketing-site.md` |
| **mobile-app** | a phone app — thumb-first, view stack + tabs, modality via sheets | header · view/scroll · bottom-tab-bar · sheets (popover/bottom/full) · global menu | `../ui-patterns/references/archetype-mobile-app.md` |
...
- **No checker, by construction.** This skill's inputs — screenshots, mockups, prose intents — resist
  ...
  *does* exist, the A1-frame facts (height chain, pane scroll, pinned chrome) are measured by [[ui-audit]]'s
