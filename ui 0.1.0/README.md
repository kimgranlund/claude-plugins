...
| `agents/component-reviewer.md` | Subagent (adversarial critic) | dispatched (Task tool, model `opus`) | Grades ONE component/composition against `component-forge`'s Compose x Realize method and its three checkers; preloads `component-forge` only |
