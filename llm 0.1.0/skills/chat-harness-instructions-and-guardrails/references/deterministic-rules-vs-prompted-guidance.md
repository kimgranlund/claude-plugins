...
mechanism, not a hypothetical: it is what actually caught the sibling `llm-provider-gateway` and
`llm-jsonl-streaming` skills' own description-length overruns during their authoring.
