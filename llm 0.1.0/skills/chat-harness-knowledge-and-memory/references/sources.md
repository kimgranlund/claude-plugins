...
- **This very skill family** (`/Users/kimba/Projects/nonoun/plugins/llm 0.1.0/skills/`) —
  ...
  This pack (`chat-harness-knowledge-and-memory`) is itself a third instance of the same shape,
...
is [[chat-harness-skills-and-routing]]'s territory. The wire format of a model's own streaming
output is [[llm-jsonl-streaming]]'s. When a cited worked instance and its own source repo disagree
