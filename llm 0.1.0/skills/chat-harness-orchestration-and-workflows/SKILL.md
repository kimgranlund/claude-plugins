---
name: chat-harness-orchestration-and-workflows
description: >-
  ...
  single-skill routing (chat-harness-skills-and-routing); NOT run measurement
  (chat-harness-observability); NOT feature-building.
disable-model-invocation: false
user-invocable: false
---

# chat-harness-orchestration-and-workflows — composing multiple agents for one job
...
- **One skill's own trigger/description routing** (why a single skill triggers or doesn't, how to write
  its trigger phrases) → [[chat-harness-skills-and-routing]] (the sibling pack in this plugin) —
...
- **Logging, tracing, or measuring what a run actually did** (token spend, latency, which tool
  fired) → [[chat-harness-observability]] (the sibling pack in this plugin) — that pack answers
