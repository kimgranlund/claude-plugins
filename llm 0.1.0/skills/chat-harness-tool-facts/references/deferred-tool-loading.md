...
surface — described in [[chat-harness-routing-facts]]. The shape (defer the expensive
...
library's OWN model-invoked routing mechanism ([[chat-harness-routing-facts]], not this file).
