...
guaranteed to agree (see llm-streaming-facts's sse-chunk-parsing-technique for the GENERAL
...
TECHNIQUE an individual adapter uses internally ([[llm-streaming-facts]]) · the conversation/turn
