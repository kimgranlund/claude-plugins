...
The pattern: **display, heading, kicker, and code are where a distinctive face earns its keep**;
**body, ui, legal, and caption default to neutral** — legibility-at-small-sizes and broad script
