...
# typography-system-author — the per-voice font-and-rationale decision
...
1. **Interpret the territory into a specific point, not a region.** A named reference —
   ...
   (`design-system-author/references/context-potency.md`'s presupposition technique and
...
| `design-system-author/references/context-potency.md` | the presupposition / generic-output-clinic doctrine step 1 applies (read-only citation, not this skill's to edit) |
| [[component-author]] | NOT this skill's job — builds the component that consumes the type |
