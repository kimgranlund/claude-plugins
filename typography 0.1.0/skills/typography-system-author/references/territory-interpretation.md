...
`design-system-author/references/context-potency.md` (its presupposition technique and
...
`typography-tokens`, with real `typeface-check.py` output (not invented numbers):
...
This file is worked application, not the doctrine itself — `design-system-author/references/
