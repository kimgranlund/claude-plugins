...
`typography-tokens/references/font-selection.md`. That file now carries only a short fallback
...
distinctiveness mechanics cite `typography-lettering/references/voice/neutral-by-design.md` and
`typography-lettering/references/voice/distinctive-and-impactful.md`; the pairing mechanics cite
`typography-lettering/references/techniques/pairing.md`. Consult those for the design-history and
...
`typography-tokens`' five font-family roles (`display · heading · body · ui · mono`) are the
...
| Roboto | 0.528 | — (unverified) | sans | neutral | `typography-lettering/references/voice/neutral-by-design.md` |
| Arial | 0.519 | — (unverified) | sans | neutral | `typography-lettering/references/voice/neutral-by-design.md` |

¹ Inherited from `typography-tokens/references/font-selection.md`'s **pre-migration revision**
...
Roboto (0.528) and Arial (0.519) match `typography-lettering/references/metrics/metric-compatibility.md`
...
and still fight the baseline (`typography-lettering/references/techniques/pairing.md`'s own
...
from `typography-lettering/references/voice/distinctive-and-impactful.md`'s case studies, two
(Crimson Pro, Source Sans 3) from `typography-lettering/references/historical/` or external
...
|---|---|---|
| Neutral (the deliberate-disappear choice) | Inter, Roboto, Arial | Open Sans, Lato, San Francisco (`typography-lettering/references/voice/neutral-by-design.md`) |
| Editorial | Fraunces, Source Serif 4 | Newsreader — reading-optimized AND distinctive at once, the honest middle case (`typography-lettering/references/voice/distinctive-and-impactful.md`); Crimson Pro — Jacques Le Bailly's professional redesign of Sebastian Kosch's original Crimson (2009/2010), commissioned by Google³ |
| Technical | IBM Plex Sans, IBM Plex Serif | Source Sans 3 — Paul D. Hunt, Adobe's first open-source typeface (2012), humanist proportions, open apertures, companion to Source Serif (`typography-lettering/references/historical/humanist-sans.md`) |
| Code | JetBrains Mono | Fira Code |
| Distinctive (brand-forward) | Geist | Bricolage Grotesque, Space Grotesk, Playfair Display (`typography-lettering/references/voice/distinctive-and-impactful.md`) |

³ Crimson Pro is new to this corpus (not yet in `typography-lettering`) — verified via Google Fonts'
...
sourced from `typography-tokens`' bound scale — sizes are optional; omit them to skip this axis).

² Same provenance class as the metrics table above: `typography-tokens/references/font-selection.md`'s
...
typeface reads neutral or distinctive (`typography-lettering/references/voice/`), the pairing
research (`typography-lettering/references/techniques/pairing.md`), or how to bind the resulting
decision as CSS custom properties (`typography-tokens`). Read those for the "why"; this file is
