...
description: >-
  ...
  NOT for the return-block format a reviewer hands back (forge:handoff-compose); NOT for one
  ...
  campaign scoring across a whole corpus (agents-audit/skills-audit).
