...
A command-species subtype: thin routing over modules and agents, `disable-model-invocation: true` always. Cross-domain orchestrators take workflow names and forfeit the domain prefix (`/design-to-code`, `/harness-audit`); single-domain ones keep it.
