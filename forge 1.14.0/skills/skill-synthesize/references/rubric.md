...
| D4 | Naming compliance | [gate] | Each child name follows `skill-author/references/skill-naming-conventions.md` (domain-verb or noun-compound, no verb inflation, no collision) | 1: invented grammar or a collision · 3: compliant, unchecked against existing directory names · 5: compliant and explicitly checked against the corpus |
