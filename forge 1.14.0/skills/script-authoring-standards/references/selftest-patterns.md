...
> `script-authoring-standards` reference. Every shape below exists in this workspace's shipped
...
edit to one side cannot ship without the other. (The skills-audit standard names this shape
RECIPE_MISMATCH.)
