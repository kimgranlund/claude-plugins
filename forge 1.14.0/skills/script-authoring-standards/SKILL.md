---
name: script-authoring-standards
description: >-
...
forever by its selftest. This is the standard `script-forge` authors against, the audits' A4
...
- Path portability and the hard plugin boundary are owned elsewhere (`skill-authoring-standards`'
