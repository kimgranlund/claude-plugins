...
# a2ui-catalog-design — the catalog world model
...
- **Sibling knowledge packs** (route by name): the wire/message shape → `a2ui-protocol`; corpus
  exemplars + record format → `a2ui-training-corpus`; system-prompt derivation + the live-agent
  system → `a2ui-conversational-agent` (a CONSUMER of this pack).
