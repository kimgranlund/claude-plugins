...
> Source of truth: `.claude/docs/specs/specs/a2ui-training-corpus.spec.md` §2 / SPEC-R2/R3/R4, `packages/agent-ui/a2ui/src/corpus/admit.ts`, `store.ts`, ADR-0060. Verified 2026-07-07.
