...
- **`specs/specs/a2ui-training-corpus.spec.md`** — the behavior + data/schema contract (SPEC-R1…R16, N1…N6, §5 typed contracts, §5.3 error codes). Status: proposed, v0.5, 2026-07-03.
