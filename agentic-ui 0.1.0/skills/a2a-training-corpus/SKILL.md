---
name: a2a-training-corpus
description: >-
  Answers how the A2A concept/demo teaching corpus is structured, cited, and admitted
  (@agent-ui/a2a's corpus shards — the a2ui-training-corpus sibling for the agent-to-agent layer).
  ...
  judging (a2ui-training-corpus); NOT for protocol facts the records teach (a2a-protocol); NOT for
  running an actual import/admission (the repo's tools + the repo-local curation seat).
disable-model-invocation: false
user-invocable: false
---

# a2a-training-corpus — the A2A teaching-record world model
