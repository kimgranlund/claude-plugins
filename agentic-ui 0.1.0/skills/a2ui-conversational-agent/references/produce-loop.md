...
judged shard — this loop is a CALLER of retrieve(), not its owner ([[a2ui-training-corpus]]) · the
`validateA2ui` failure codes + catalog conformance rules ([[a2ui-protocol]], [[a2ui-catalog-design]]).
